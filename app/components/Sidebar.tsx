...
import { Hash, Home, Users, Timer, FileText, RotateCw, Quote, MessageSquare, Moon, Sun, BrainCircuit } from "lucide-react";
    ...
    <>
      ...
      >
        <nav className="p-4 mt-16 space-y-4 border-r border-gray-700">
          ...
          <NavItem to="/spin-wheel" icon={<RotateCw size={18} />} label="Spin Wheel" isDark={isDark} />
      ...
      <nav className="md:hidden fixed bottom-4 left-1/2 -translate-x-1/2 z-50 bg-gray-900 text-white rounded-full shadow-lg px-6 py-3 flex gap-6 items-center mt-20">
        ...
        <BottomItem to="/spin-wheel" icon={<RotateCw size={20} />} />
